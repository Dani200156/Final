...
modelo='C:/Users/roder/Desktop/proyecto final/Dedos/ModelosVocales.h5'
peso='C:/Users/roder/Desktop/proyecto final/Dedos/pesosVocales.h5'
cnn=load_model(modelo)
cnn.load_weights(peso)

direccion='C:/Users/roder/Desktop/proyecto final/Dedos/fotos/validacion'
dire_img=os.listdir(direccion)
print('nombre:',dire_img)

cap=cv2.VideoCapture(0)

clase_manos = np.solutions.hands
manos=clase_manos.Hands()

dibujo=np.solutions.drawing_utils
